...
module.exports.run = async (client, message, args, embed_color, lang) => {
    ...
    giphy.search("hug", function (err, res) {
        let embed = new Discord.MessageEmbed()
            .setColor(embed_color)
            .setAuthor(`${message.author.username}${lang.commands.hug.embeds.titles[0]}${person}`, message.author.displayAvatarURL())
...
module.exports.aliases = ["przytul"]