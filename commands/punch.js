...
module.exports.run = async (client, message, args, embed_color, lang) => {
    ...
    giphy.search("punch", function (err, res) {
        let embed = new Discord.MessageEmbed()
            .setColor(embed_color)
            .setAuthor(`${message.author.username} ${lang.commands.punch.embeds.titles[0]} ${person}`, message.author.displayAvatarURL())
